...
import { FileText, Upload, MessageCircle, ArrowRight, Zap, Shield, GraduationCap, Code, Brain, Lock, CheckCircle2, AlertCircle, Check, HelpCircle, Plus, Minus } from 'lucide-react';
    ...
    const features = [
        {
            ...
            description: 'Summarize textbooks and notes instantly. Perfect for last-minute revision.'
        },
        {
            icon: Code,
            title: 'For Developers',
            description: 'Navigate tech specs and API docs without the headache. Find answers fast.'
        },
        {
            icon: Brain,
            title: 'Research Assistant',
            description: 'Break down complex papers into simple insights. Save hours of reading time.'
        },
        {
            icon: Zap,
            title: 'Instant Answers',
            description: 'Just ask and get the exact info you need. No more Ctrl+F searches.'
        },
        {
            icon: MessageCircle,
        ...
        },
        {
            ...
            description: 'Your documents and research stay yours. 100% private and secure.'
        }
    ];
    ...
    const faqs = [
        {
            ...
            answer: "Currently, we support PDF files up to 20MB. This covers most textbooks, research papers, and legal documents. If you need more, let us know!"
        },
        {
            question: "Which languages do you support?",
            answer: "DocuChat AI works best with English, but works with documents in Spanish, French, German, and many others. You can even chat in a different language than the document!"
        },
        {
            question: "How long do you store my data?",
            answer: "Your chats and uploaded documents are stored securely for 30 days while you work on them. After that, they are automatically deleted to ensure your privacy."
        },
        {
            question: "Is there a free plan?",
            answer: "Yes! You can upload and analyze up to 3 documents per day completely for free. We also offer a Pro plan for power users who need unlimited access."
        },
        {
            question: "Do you support scanned PDFs?",
            answer: "We rely on extracting text from the file, so clear scans with OCR (selectable text) work perfectly. For images-only scans, results may vary."
        },
        {
            question: "Do I need to log in?",
            answer: "You can try a demo chat without logging in! To save your chat history and uploaded documents for later, you'll need to create a free account."
        }
    ];
            ...
            <nav className="relative z-10 px-4 sm:px-6 lg:px-8 py-3 border-b border-vintage-gray-200 bg-vintage-white/95 backdrop-blur-sm">
                <div className="max-w-6xl mx-auto flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-lg sm:text-xl font-display font-semibold tracking-vintage">DocuChat AI</span>
                    </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="space-y-4 sm:space-y-6">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold tracking-vintage text-vintage-black animate-slide-up">
                            Master Your<br /><span>Documents </span>
                            <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium text-vintage-gray-700">with AI</span>
                        </h1>
                        ...
                        <p className="text-base sm:text-lg md:text-xl text-vintage-gray-600 max-w-2xl mx-auto leading-relaxed animate-slide-up animation-delay-200 px-4 sm:px-0">
                            The ultimate study partner and research assistant. Upload notes, tech docs, or research papers and get answers instantly. No jargon, just clear results.
                        </p>
                    </div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-8 sm:mb-12">
                        ...
                        <p className="text-vintage-gray-600 text-sm sm:text-base max-w-2xl mx-auto px-4 sm:px-0">
                            Whether you are coding, studying, or researching—DocuChat AI helps you understand faster.
                        </p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-vintage-white p-6 rounded-xl border border-vintage-gray-200 shadow-sm flex flex-col md:flex-row items-start md:items-center gap-6 group hover:shadow-md transition-shadow">
                            <div className="flex-1 space-y-2">
                                ...
                                <p className="text-vintage-gray-700">"I don't have time to read 100+ pages for one specific answer."</p>
                            </div>
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <p className="text-vintage-gray-700">DocuChat AI scans the entire PDF instantly and gives you the exact answer in seconds.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-vintage-white p-6 rounded-xl border border-vintage-gray-200 shadow-sm flex flex-col md:flex-row items-start md:items-center gap-6 group hover:shadow-md transition-shadow">
                            <div className="flex-1 space-y-2">
                                ...
                                <p className="text-vintage-gray-700">"The language is too technical and hard to understand."</p>
                            </div>
                            <div className="hidden md:block w-px h-16 bg-vintage-gray-200"></div>
                            <div className="flex-1 space-y-2">
                                <div className="flex items-center gap-2 text-green-600 font-semibold mb-1">
                                ...
                                <p className="text-vintage-gray-700">Ask DocuChat AI to "explain like I'm 5," and get a simple, jargon-free summary.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-vintage-white p-6 rounded-xl border border-vintage-gray-200 shadow-sm flex flex-col md:flex-row items-start md:items-center gap-6 group hover:shadow-md transition-shadow">
                            <div className="flex-1 space-y-2">
                                ...
                                <p className="text-vintage-gray-700">"I keep losing my place and forgetting key details."</p>
                            </div>
                            <div className="hidden md:block w-px h-16 bg-vintage-gray-200"></div>
                            <div className="flex-1 space-y-2">
                                <div className="flex items-center gap-2 text-green-600 font-semibold mb-1">
                                ...
                                <p className="text-vintage-gray-700">DocuChat AI remembers the context of your chat, making it easy to connect the dots.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        <div className="bg-vintage-white p-6 rounded-xl border border-vintage-gray-200 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex items-center space-x-1 mb-4">
                                {[...Array(5)].map((_, i) => (
                                    <div key={i} className="w-4 h-4 text-vintage-orange fill-current">★</div>
                                ))}
                            </div>
                            <p className="text-vintage-gray-700 mb-6 text-sm sm:text-base leading-relaxed">
                                "I used to spend hours summarizing notes for finals. DocuChat AI breaks down entire chapters in seconds—it saved my GPA!"
                            </p>
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="font-semibold text-sm text-vintage-black">Priya Sharma</p>
                                    <p className="text-xs text-vintage-gray-500">Computer Science Student</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-vintage-white p-6 rounded-xl border border-vintage-gray-200 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-vintage-gray-700 mb-6 text-sm sm:text-base leading-relaxed">
                                "Reading 50-page API documentation is a nightmare. DocuChat AI points me exactly to the endpoints I need instantly."
                            </p>
                            <div className="flex items-center space-x-3">
                                <div className="w-10 h-10 bg-vintage-gray-200 rounded-full flex items-center justify-center font-display font-bold text-vintage-gray-600">
                                    RV
                                ...
                                <div>
                                    <p className="font-semibold text-sm text-vintage-black">Rahul Verma</p>
                                    <p className="text-xs text-vintage-gray-500">Backend Developer</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-vintage-white p-6 rounded-xl border border-vintage-gray-200 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-vintage-gray-700 mb-6 text-sm sm:text-base leading-relaxed">
                                "Analyzing research papers takes half the time now. It explains complex methodologies so clearly, I can focus on writing."
                            </p>
                            <div className="flex items-center space-x-3">
                                <div className="w-10 h-10 bg-vintage-gray-200 rounded-full flex items-center justify-center font-display font-bold text-vintage-gray-600">
                                    AG
                                ...
                                <div>
                                    <p className="font-semibold text-sm text-vintage-black">Dr. Ananya Gupta</p>
                                    <p className="text-xs text-vintage-gray-500">Research Analyst</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="relative z-10 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-vintage-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                        We understand that your documents contain sensitive information. That's why DocuChat AI is built with privacy at its core—your files are processed securely and are never used to train our public models.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                        <div className="flex flex-col space-y-2 p-4 rounded-lg bg-vintage-white border border-vintage-gray-100">
                            ...
                            <p className="text-sm text-vintage-gray-600">All uploads and chats are encrypted in transit and at rest.</p>
                        </div>
                        <div className="flex flex-col space-y-2 p-4 rounded-lg bg-vintage-white border border-vintage-gray-100">
                            <h3 className="font-semibold text-vintage-black flex items-center gap-2">
                                <Brain className="w-4 h-4" /> No AI Training
                            </h3>
                            <p className="text-sm text-vintage-gray-600">Your private data is never used to train our AI models.</p>
                        </div>
                        <div className="flex flex-col space-y-2 p-4 rounded-lg bg-vintage-white border border-vintage-gray-100">
                            <h3 className="font-semibold text-vintage-black flex items-center gap-2">
                                <Upload className="w-4 h-4" /> Easy Delete
                            </h3>
                            <p className="text-sm text-vintage-gray-600">You have full control. Delete your files instantly, anytime.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative z-10 py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    <div className="inline-flex items-center justify-center p-2 bg-purple-100 rounded-lg mb-6">
                        ...
                        <span className="text-sm font-medium text-purple-700">Built with 💙</span>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-vintage-white to-vintage-gray-50 p-8 rounded-2xl border border-vintage-gray-200 shadow-sm relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h3 className="text-xl font-bold text-vintage-black mb-4">Hi, I'm Naresh! 👋</h3>
                            <p className="text-vintage-gray-700 leading-relaxed mb-4">
                                I'm a Full Stack Developer from India who knows the struggle of drowning in documentation.
                                I built DocuChat AI because I needed a faster way to understand complex research papers and technical docs without spending hours reading every single line.
                            </p>
                            <p className="text-vintage-gray-700 leading-relaxed">
                                Whether you're a student cramming for finals or a dev trying to figure out a new API, I hope this tool helps you learn faster and build better things.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="space-y-4">
                        ...
                        <p className="text-vintage-gray-600 text-sm sm:text-base max-w-xl mx-auto px-4 sm:px-0">
                            Join thousands of students and developers who are saving time with DocuChat AI.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4 max-w-3xl mx-auto">
                        {faqs.map((faq, index) => (
                            ...
                            >
                                ...
                                >
                                    <span className={`font-semibold text-lg transition-colors ${openFaqIndex === index ? 'text-vintage-orange' : 'text-vintage-black'}`}>
                                        {faq.question}
                                    </span>
                                    <span className={`flex-shrink-0 ml-4 p-1 rounded-full border transition-all duration-300 ${openFaqIndex === index
                                ...
                                <div
                                    className={`transition-all duration-300 ease-in-out ${openFaqIndex === index ? 'max-h-48 opacity-100 mb-6' : 'max-h-0 opacity-0'
                                        }`}
                                >
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        <div className="col-span-1 md:col-span-1">
                            <div className="flex items-center space-x-2 mb-4">
                                ...
                                <span className="font-display font-bold text-lg text-vintage-black">DocuChat AI</span>
                            </div>
                            <p className="text-sm text-vintage-gray-600">
                                AI-powered PDF analysis for students, researchers, and professionals.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-vintage-gray-600">
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Features</a></li>
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Pricing</a></li>
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Testimonials</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-vintage-gray-600">
                                <li><a href="#" className="hover:text-vintage-black transition-colors">About Us</a></li>
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Contact</a></li>
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Blog</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-vintage-gray-600">
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Privacy Policy</a></li>
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Terms of Service</a></li>
                                <li><a href="#" className="hover:text-vintage-black transition-colors">Cookie Policy</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="pt-8 border-t border-vintage-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center space-x-6">
                            <a href="#" className="text-vintage-gray-400 hover:text-vintage-gray-600 transition-colors">
