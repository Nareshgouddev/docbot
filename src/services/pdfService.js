    ...
    try {
        ...
        try {
            ...
            metadata = {
                ...
                creationDate: (pdfMetadata.info && 'CreationDate' in pdfMetadata.info) ? pdfMetadata.info.CreationDate : null,
                keywords: (pdfMetadata.info && 'Keywords' in pdfMetadata.info) ? pdfMetadata.info.Keywords : '',
            };
        } catch (metaError) {
...
export const cleanupPDFResources = (attachment) => {
...
export const searchInPDF = (text, query) => {
    if (!text || !query) return false;
    return text.toLowerCase().includes(query.toLowerCase());
};

// Get PDF statistics
export const getPDFStats = (attachment) => {
